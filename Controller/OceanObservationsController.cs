...
namespace OceanObservationAPI.Controllers
{
    ...
    public class OceanObservationsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<OceanObservation>> PostOceanObservation(OceanObservation observation)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutOceanObservation(int id, OceanObservation observation)
        {
